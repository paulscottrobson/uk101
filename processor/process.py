...
modes["ix"] = { "eac":"temp8 = (Fetch()+x) & 0xFF;eac = ReadWord01(temp8);", "cycles":3, "desc":"(@1,X)" }
modes["iy"] = { "eac":"temp8 = Fetch();eac = (ReadWord01(temp8)+y) & 0xFFFF;", "cycles":2, "desc":"(@1),Y" }
modes["iz"] = { "eac":"temp8 = Fetch();eac = ReadWord01(temp8);", "cycles":2, "desc":"(@1)" }
